...
/**
 * Program to return an optimal firefighter solution (may be unattainable in practice)
 * 
 * @author ethankelly
 *
 */

// Code not yet functional, accessory code only


public class OptimalFirefighter extends Graph {

	/**
	 * @param numVertices
	 */
	public OptimalFirefighter(int numVertices) {
		super(numVertices);
