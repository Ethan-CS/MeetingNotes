...
_Update 28/04/21 09:15: Ethan has implemented methods that
1. Give naive upper (clique) and lower (cycle) bounds for given graphs, and 
2. Splice a graph into subgraphs based on cut-vertices._
