...
/**
 *  The {@code io.github.ethankelly.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code io.github.ethankelly.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">io.github.ethankelly.StdIn.java</a>
 ...
 *  <pre>
 *  while (!io.github.ethankelly.StdIn.isEmpty()) {
 *      double value = io.github.ethankelly.StdIn.readDouble();
 *      io.github.ethankelly.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (io.github.ethankelly.StdIn.hasNextChar()) {
 *      char c = io.github.ethankelly.StdIn.readChar();
 *      io.github.ethankelly.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (io.github.ethankelly.StdIn.hasNextLine()) {
 *      String line = io.github.ethankelly.StdIn.readLine();
 *      io.github.ethankelly.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = io.github.ethankelly.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code io.github.ethankelly.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code io.github.ethankelly.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code io.github.ethankelly.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code io.github.ethankelly.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code io.github.ethankelly.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code io.github.ethankelly.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code io.github.ethankelly.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code io.github.ethankelly.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code io.github.ethankelly.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to io.github.ethankelly.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to io.github.ethankelly.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to io.github.ethankelly.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to io.github.ethankelly.StdIn
    
    
    // do this once when io.github.ethankelly.StdIn is initialized
    static {
        resync();
    }

    /**
     * If io.github.ethankelly.StdIn changes, use this to reinitialize the scanner.
     */
