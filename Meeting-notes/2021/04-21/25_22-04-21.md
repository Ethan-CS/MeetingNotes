...
_Update 28/04/21 10:35: Ethan believes the lower bound for number of equations should be a path on $N$ vertices, rather than a cycle, i.e. minimally connected graph with $N$ vertices should have $N-1$ edges._
